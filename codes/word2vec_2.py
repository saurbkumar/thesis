...
#    model_name = "wordToVecModel_" + str(i)
...
logistic_reg = []  
print "Initializing.."
for counter,i in enumerate(range(10,200,10)):
    print(i)
    num_feature = i
